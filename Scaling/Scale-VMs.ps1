...
.NOTES 
    ...
    Version:      1.0.0     Initial Build Travis Roberts see here for his information https://www.ciraltos.com/automatically-start-and-stop-wvd-vms-with-azure-automation/
                  2.0.2     Updates made by Kandice Hendricks see here https://github.com/KandiceLynne/AzureRunbooks/blob/master/AutoScaleWVD.ps1    
                  3.0.0     Updated script for the spring release version of WVD 
    #>
   ...
   # Host Resource Group
        $sessionHostRg = 'your-resource-group'
